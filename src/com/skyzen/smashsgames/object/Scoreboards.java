...
public class Scoreboards {
    ...
    private static String title[] = {"§e§lEl§6§lytra§b§lRace", "§f§lEl§e§lyt§6§lra§b§lRace", "§e§lEl§f§lyt§e§lra§b§lRace", "§6§lEl§e§lyt§f§lra§b§lRace", "§f§lEl§e§lyt§6§lra§a§lRace"};
