...
public class Scoreboards {
    ...
    private static String title[] = {"§f§lS§e§lmashs§b§lBuild", "§e§lS§f§lm§e§la§6§lshs§b§lBuild", ChatColor.GOLD + "§lS§e§lm"+ ChatColor.WHITE + "§la§e§ls§6§lhs§b§lBuild", "§6§lSm§e§la§f§ls§e§lh§6§ls§b§lBuild", "§6§lSma§e§ls§f§lh§e§ls§b§lBuild", "§e§lS§6§lmas§e§lh§f§ls§b§lBuild", "§6§lSmash§e§ls§a§lBuild"};
